...
export type OrderStatus = 'draft' | 'confirmed' | 'processing' | 'ready' | 'delivered' | 'cancelled' | 'partial';
export type PaymentStatus = 'unpaid' | 'partial' | 'paid' | 'overdue';
export type PaymentMethod = 'cash' | 'bank' | 'transfer' | 'card' | 'cheque' | 'credit';
...
export interface Supplier { id: string; name: string; phone?: string; address?: string; email?: string; notes?: string; active?: boolean; [key: string]: any; }
...
export interface CashRegister { id: string; name?: string; balance?: number; openingBalance?: number; closingBalance?: number; date?: string; [key: string]: any; }
